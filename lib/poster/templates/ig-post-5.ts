...
export const IG_POST_5: PosterTemplate = {
  ...
  layers: [
    ...
    // Main card
    { id: "card", type: "rect", x: 70, y: 90, width: 940, height: 900, color: "secondary", cornerRadius: 40, opacity: 0.9 },

    // Left rail accent
    { id: "rail", type: "rect", x: 70, y: 90, width: 60, height: 900, color: "accent", cornerRadius: 40, opacity: 0.18 },

    { id: "logo", type: "logo", x: 160, y: 150, width: 130, height: 130 },
